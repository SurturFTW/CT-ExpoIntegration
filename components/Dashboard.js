...
const Dashboard = ({ route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                style={styles.button}
                onPress={appUtils.multiValueEvent}
            >
                <Text style={styles.buttonText}>Multi-Value Event</Text>
            </TouchableOpacity>

            <TouchableOpacity
                style={styles.button}
                onPress={appUtils.pushNestedEvent}
            >
                <Text style={styles.buttonText}>Nested Event</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
                style={styles.button}
                onPress={appUtils.show_appInbox}
            >
